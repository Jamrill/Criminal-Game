...
namespace JuegoCriminal.UI
{
    public sealed class MenuTransitionController : MonoBehaviour
    {
        ...
        private IEnumerator OptionsRoutine(GameObject optionsPanel)
        {
            ...
            // dentro del bucle escalonado, los botones pendientes serían visibles
            // durante unos fotogramas en su posición final.
        ...
        private IEnumerator BackFromOptionsRoutine(GameObject optionsPanel)
        {
            ...
            // La salida termina arriba, pero esa posición es únicamente visual.
            // Restauramos la posición real antes de desactivar el panel para que
